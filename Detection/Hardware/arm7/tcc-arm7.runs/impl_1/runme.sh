...
HD_PWD='C:/RTDDoS/Detection/Hardware/arm7/tcc-arm7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nahid.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nahid.tcl -notrace
