...
HD_PWD='C:/RTDDoS/Detection/Hardware/arm7/tcc-arm7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nahid.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nahid.tcl
