...
\titulo{PROJETO DE UM FRAMEWORK DE DETECÇÃO DE ATAQUES DISTRIBUÍDOS DE NEGAÇÃO DE SERVIÇO }
\autor{BRUNO RICCELLI DOS SANTOS SILVA}
\local{Fortaleza, Ceará}
\data{2017}
\orientador{Prof. RICARDO JARDEL NUNES DA SILVEIRA}
\coorientador{Prof. MARCELO ARAÚJO LIMA}
...
%\include{cap2/stateoftheart}

\include{cap3/metodologia}

%\include{cap4/algoritmoscomparados}

%\include{cap5/resultados}

%\include{cap6/conclusoes}
