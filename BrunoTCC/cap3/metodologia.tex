...
Neste capítulo, os detalhes do \textit{framework} são apresentados, bem como a modelagem do ambiente de simulação utilizado para a detecção de ataques DDoS. 
