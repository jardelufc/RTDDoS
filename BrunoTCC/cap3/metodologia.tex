...
A \tabref{Tab:entropía} mostra exemplos com valores de entrada para entropia, bem como o resultado do cálculo da função.
%\begin{table}[!htb]
%	\centering
...
%		\begin{tabular}{c c }
%			\toprule
%			\textbf{IP origem}  \\ \midrule  \textbf{Entropia}    \\ \midrule
