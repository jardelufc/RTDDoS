...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   \assinatura{Prof. Marcelo Araújo Lime (Co-Orientador)\\ Instituto Federal do Ceará (IFCE) }
   \assinatura{Prof. Dr. Jarbas Aryel da Silveira \\ Universidade Federal do Ceará (UFC)}
   %DEFINA AQUI OS DEMAIS MEMBROS DA BANCA
   \assinatura{Prof. Daniel Alencar Barros Tavares \\ Instituto Federal do Ceará (IFCE)}
