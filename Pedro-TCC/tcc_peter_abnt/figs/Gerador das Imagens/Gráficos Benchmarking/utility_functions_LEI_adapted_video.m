...
% req_rt = 20e-3; % Requirement for RT = 20ms
...
req_nrt = 200e-3; % Requirement for NRT = 200ms
x_nrt = 0:1e-5:2*req_nrt;
alpha_nrt = 5;
c_nrt = 0.5;
% req_nrt = 150e-3; % Requirement for NRT = 150ms
% x_nrt = 0:1e-5:2*req_nrt;
% alpha_nrt = 0.1;
% c_nrt = 0.5;
...
figure;
marginal_rt = (0.375/62)*sigma_rt*(exp(-sigma_rt*(x_nrt - req_rt)))./((1 + exp(-sigma_rt*(x_nrt - req_rt))).^2);
